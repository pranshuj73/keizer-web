    ...
    >
      <div className="mx-auto max-w-[1536px]">
        <img
          ...
          className="absolute left-[220px] md:block hidden"
        />
        <div className="dot-grid " />
        <div className="md:pt-[238px] pt-[138px]">
          <div className="relative">
            ...
            <div className="md:absolute p-[20px] md:top-[50%] md:-translate-y-1/2 md:right-[10px] lg:right-[190px]">
              <h1 className="lg:text-[98px] md:text-[78px] text-[40px] md:ml-[8px] group translate-y-1 font-[700] md:leading-[75px] lg:leading-[98px] leading-[45px] tracking-[102%] capitalize">
                Unleashing
              ...
              <p
                className={`mt-[35px]  translate-y-2 ${dM_Mono.className} [word-spacing:4px] tracking-[-99%] font-[400] opacity-65 lg:leading-[30px] md:leading-[18px] leading-[20px] lg:text-[19px] md:text-[17px] text-[15px] md:w-[500px] lg:w-[800px]`}
              >
              ...
              <Link
                href="#contact"
                className="pt-[30px] md:translate-y-4  md:text-[17.8px] text-[14px] inline-block group border-b-2 border-white pb-[6px]"
              >
