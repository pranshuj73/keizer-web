	...
	return (
		<div className="absolute  top-[25rem] -z-50 opacity-50">
			<div className="max-w-full relative overflow-hidden">
				<div className="absolute inset-0 bg-gradient-to-tr from-black/80 from-5% via-black/80 via-50% to-transparent to-95% z-10" />
				{/* <div className="absolute pointer-events-none inset-0 z-50 flex items-center justify-center  bg-[#1A1A1A] bg-dot [mask-image:radial-gradient(ellipse_at_center,transparent_2%,black)]"></div> */}
